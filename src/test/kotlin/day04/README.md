...
me with something quick, I'll let you _borrow my boat_ and you can go visit the gardener. I got all
...
bar (`|`): a list of _winning numbers_ and then a list of _numbers you have_. You organize the information into a
...
and `86`) are winning numbers! That means card 1 is worth `_8_` points (1 for the first match, then doubled three times
